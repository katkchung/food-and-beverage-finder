...
export const restaurants = {
  [Genre.American]: [
    {
      name: "Hell's Kitchen",
      id: "g7bbpP7x5KAc33i7pgOkLA",
    },
    {
      name: "Blue Door Pub Como",
      id: "TuFYsQCKhNKuiKIZ6Bw3EA",
    },
  ],
  [Genre.Asian]: [
    {
      name: "Sushi Train",
      id: "FR9ZFGmwrrxCrolxZDy6NQ",
    },
    {
      name: "Sushi Takatsu",
      id: "ddpjLv0P6iu7p1dRGCPWWw",
    },
  ],
  [Genre.Boba]: [
    {
      name: "Mi Tea",
      id: "43p95RkcHPHbCoJLFSpdeA",
    },
    {
      name: "Ding Tea",
      id: "F38zcGJ2FerUQo--3dw1cA",
    },
  ],
  [Genre.Brunch]: [
    {
      name: "Lands End Pasty Company",
      id: "kLIRGu0p-j8ilVO-SfkWZw",
    },
    {
      name: "Isles Bun & Coffee",
      id: "sdeYah2re9mvnHEsbIPsOw",
    },
  ],
  [Genre.Mediterranean]: [
    {
      name: "Wally's Falafel and Hummus",
      id: "VVU19gaxLPKyzWSITKMC1Q",
    },
    {
      name: "Olympia Cafe & Gyros",
      id: "XBoB1vc_b9RU_UzxsBie-g",
    },
  ],
  [Genre.Mexican]: [
    {
      name: "Rusty Taco",
      id: "fq9jC-Jl55VySyZ66-nN1A",
    },
    {
      name: "Yeah Yeah Taco",
      id: "R5371sng0zz7icCHxlpsoQ",
    },
  ],
  [Genre.Italian]: [
    {
      name: "Galactic Pizza",
      id: "dBRIlzRYdvAhSdxOTBVYyw",
    },
    {
      name: "Young Joni",
      id: "5Y2nekkwRrNMMSx3b-2EhA",
    },
  ],
}

export const RestaurantMap = new Map<string, RestaurantDTO>([
  ...
  [
    ...
    { id: "JVIwGOKo9E774uLGVFYNwA", genre: Genre.Asian },
  ],
  ...
  [
    ...
    { id: "Mopw-koOu2bP9kPIl1v6Sg", genre: Genre.Asian },
  ],
  ["Peking Garden", { id: "w6s7oKGHCCDNzSbAjw6FjA", genre: Genre.Asian }],
  [
    "Moto-i Ramen and Sake House",
    { id: "oidsSjjDxAliG3PFXxLQiA", genre: Genre.Asian },
  ],
  [
    "Peninsula Malaysian Cuisine",
    { id: "Xnsa4CJMPqyHkyISgxrzxg", genre: Genre.Asian },
  ],
  ...
  [
    ...
    { id: "VVU19gaxLPKyzWSITKMC1Q", genre: Genre.Mediterranean },
  ],
  [
    "Olympia Cafe & Gyros",
    { id: "XBoB1vc_b9RU_UzxsBie-g", genre: Genre.Mediterranean },
  ],
  ["Hell's Kitchen", { id: "g7bbpP7x5KAc33i7pgOkLA", genre: Genre.American }],
  [
    "Blue Door Pub Como",
    { id: "TuFYsQCKhNKuiKIZ6Bw3EA", genre: Genre.American },
  ],
  ...
  [
    ...
    { id: "HL8GOJJsauMCD8TET7UmNg", genre: Genre.Mexican },
  ],
  ...
  [
    ...
    { id: "kLIRGu0p-j8ilVO-SfkWZw", genre: Genre.Brunch },
  ],
